                ...
                <div className="w-[95%] md:w-full md:max-w-[85%] mx-auto px-2 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4">
                        ...
                        <div className="space-y-3">
                            ...
                            <ul className="space-y-4">
                                <li>
                                    <Link href="https://youtube.com" className="text-base text-black dark:text-gray-300 dark:hover:text-white">
                                        Youtube
                                    </Link>
                                </li>
                                <li>
                                    <Link href="https://instagram.com" className="text-base text-black dark:text-gray-300 dark:hover:text-white">
                                        Instagram
                                    </Link>
                                </li>
                                <li>
                                    <Link href="https://github.com" className="text-base text-black dark:text-gray-300 dark:hover:text-white">
                                        github
                                    </Link>
                                </li>
                            </ul>
                        ...
                        <div className="space-y-3">
                            ...
                            <ul className="space-y-4">
                                <li className="text-base text-black dark:text-gray-300">
                    ...
                    <div className="mt-8 border-t border-[#0000000e] dark:border-[#ffffff1e] pt-6 text-center">
