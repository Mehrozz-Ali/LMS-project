...
const CourseDetails = ({ data, stripePromise, clientSecret }: Props) => {
    ...
    const isPurchased = user && user?.courses?.find(
                ...
                <div className="w-full flex flex-col-reverse md:flex-row">
                                ...
                                {(data?.reviews && [...data.reviews].reverse()).map((item: any, index: number) => (
                                    <div className="w-full pb-4" key={index}>
                                        <div className="flex">
                                            ...
                                            <div className="pl-2 flex md:hiddem items-center">
                                                <h5 className="text-[18px] pr-2 text-black dark:text-white">{item.user.name}</h5>
                                                <Ratings rating={item.rating} />
                                            </div>
                                        </div>
                    ...
                    <div className="w-full md:w-[35%] relative">
                        <div className="sticky top-[100px] left-0 z-50 w-full">
                            ...
                            <p className="pb-3 md:pb-1 text-black dark:text-white">• Premium Support</p>
