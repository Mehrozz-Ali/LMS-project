    ...
    return (
        <div className="w-[90%] m-auto py-5 mb-5">
            <div className="w-full relative">
                ...
                <div className="flex items-center">
                    <div className={`${styles.button} !w-[180px] my-3 font-Poppins !bg-[crimson] cursor-not-allowed`}>But Now {courseData?.price}</div>
                </div>
                ...
                <div className="flex items-center">
                    <input type="text"
                        ...
                        className={`${styles.input} 1500px:!w-[50%] md:!w-[60%] ml-3 !mt-0`}
                    />
