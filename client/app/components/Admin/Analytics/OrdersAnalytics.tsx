        ...
        <>
            {
                isLoading ? (
                    ...
                    <div className={`${!isDashboard ? "mt-[50px]" : "mt-[50px] dark:bg-[#111C43] shadow-sm pb-5 rounded-sm"}`}>
                        ...
                        <div className={`w-full ${!isDashboard ? "h-[100vh]" : "h-[70vh]"} flex items-center justify-center`}>
                            <ResponsiveContainer width={isDashboard ? "100%" : "90%"} height={isDashboard ? "100%" : "50%"}>
                                ...
                                >
                                    <CartesianGrid strokeDasharray="3 3" vertical={true} horizontal={true} stroke="#555" />
                                    <XAxis dataKey="name" />
                                    <YAxis />
                                    <Tooltip />
                                    {!isDashboard && <Legend />}
